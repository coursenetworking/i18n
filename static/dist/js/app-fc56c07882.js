...
i18n.directive("langsectioncreate", function(){
    return {
        restrict: "AE",
        templateUrl: "static/static/tpl/lang-section-create-33bab5b761.html",
        replace: true
    }
});
...
i18n.directive("langsectionedit", function(){
    return {
        restrict: "AE",
        templateUrl: "static/static/tpl/lang-section-edit-e799345f68.html",
        replace: true
    }
});
...
i18n.directive("langsectionview", function(){
    return {
        restrict: "AE",
        templateUrl: "static/static/tpl/lang-section-view-1e250cb674.html",
        replace: true
    }
});
...
i18n.directive("langsectionlist", function(){
    return {
        restrict: "AE",
        template: "<section class=\"panel panel-lang\" ng-repeat=\"(k, section) in sections|filter:searchSection as results\" ng-switch=\"supermode\"><div ng-switch-when=\"true\" langsectionform></div><div ng-switch-default langsectionview></div></section>",
        replace: true
    }
});
